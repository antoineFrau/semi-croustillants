    ...
    public function handle($request, Closure $next)
    {
        try {
            ...
            if ($e instanceof \Tymon\JWTAuth\Exceptions\TokenInvalidException){
                return response()->json(['error' => ['type' => 'token_invalid', 'message' => 'Token is invalid, must re-authenticate the user.']], 401);
                ...
                try {
                    ...
                    return response()->json(['error' => ['type' => 'token_expired', 'message' => 'Token is now expired, must re-authenticate the user.']], 401);
                }
            }else {
